...
router.post('/', role_1.adminRequired, async (req, res) => {
    ...
    try {
        ...
        budgetUSD, teamSlots, description, documents, deadline, } = (_a = req.body) !== null && _a !== void 0 ? _a : {};
        ...
        return res.status(500).json({ message: (_b = err === null || err === void 0 ? void 0 : err.message) !== null && _b !== void 0 ? _b : 'Internal error' });
    }
});
/* -----------------------------------------------------------
...
router.get('/', role_1.adminRequired, async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ message: (_a = err === null || err === void 0 ? void 0 : err.message) !== null && _a !== void 0 ? _a : 'Internal error' });
    }
});
/* -----------------------------------------------------------
...
router.patch('/:id', role_1.adminRequired, async (req, res) => {
    ...
    try {
        ...
        if (!Number.isFinite(id))
            return res.status(400).json({ message: 'Invalid id' });
        const { title, buyer, sector, location, status, contract, budgetUSD, teamSlots, description, documents, deadline, } = (_a = req.body) !== null && _a !== void 0 ? _a : {};
